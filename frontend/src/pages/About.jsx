  ...
  return (
    <div className="about-page">
      ...
      >
        ...
        >
          Welcome to <span className="text-blue-400">Oman Tourism</span>
        </motion.h1>
        <motion.p
      ...
      <section className="about-intro py-16 px-4 bg-light-gray">
        ...
        >
          ...
          >
            About <span className="text-blue-500">Oman Tourism</span>
          </motion.h2>
          <motion.p
            className="text-lg"
            initial={{ opacity: 0, y: -20 }}
          ...
          >
            Oman Tourism is a leading travel agency offering personalized booking
      ...
      <section className="contact-info py-16 bg-light-gray text-center">
        ...
        >
          ...
          <div className="mt-12 text-center">
            <a
              href="mailto:ifon@omantourism.com"
